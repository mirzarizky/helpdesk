...
<script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/<?php echo e(Kordy\Ticketit\Helpers\Cdn::Summernote); ?>/summernote.min.js" defer></script>
...
$(document).ready(function() {
        var options = $.extend(true,
          {lang: '<?php echo e($editor_locale); ?>' <?php echo $codemirror_enabled ? ", codemirror: {theme: '{$codemirror_theme}', mode: 'text/html', htmlMode: true, lineWrapping: true}" : ''; ?> },
          <?php echo $editor_options; ?>,
          {'tabsize': 2},
          {'height': 250}
         );
