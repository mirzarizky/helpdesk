...
<head>
    ...
    @if(Request::is( Config::get('chatter.routes.home') ) || Request::is( Config::get('chatter.routes.home') . '/*' ))
        ...
        <link rel="stylesheet" href="{{ asset('css/forum.min.css') }}" />
    @endif
