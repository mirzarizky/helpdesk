...
<section class="section-mobile-content">
    <ul class="mobile-help">
      ...
      @foreach($topics as $topic)
        <li class="pl-15 pr-10"><a href="{{url('mobile/detail/'.$id.'/'.$topic->slug)}}" class="font-list-mobile" title="">{{$topic->title}} <i class="material-icons float-right">chevron_right</i></a></li>
      @endforeach
      @else
        <li class="pl-15 pr-10">{{trans('web.not_found')}}</li>
      @endif
    </ul>
</section>
